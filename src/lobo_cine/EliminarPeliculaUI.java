 ...
 * @author jessi
 */
public class EliminarPeliculaUI extends javax.swing.JFrame {
    private Admin admin;
    ...
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(EliminarPeliculaUI.class.getName());

    /**
     * Creates new form EliminarPeliculaUI
     */
    public EliminarPeliculaUI(Admin admin) {

        this.admin = admin;
        this.db = BaseDatos.getInstancia();
        this.peliculas = db.getPeliculas();
        ...
        JLabel titulo = new JLabel("ELIMINAR PELÍCULA", SwingConstants.CENTER);
        ...
        if (peliculas.isEmpty()) {
            modelo.addElement("No hay películas disponibles");
        } else {
    ...
    db.eliminarFuncionesDePelicula(seleccionada);
    db.eliminarPelicula(seleccionada);
